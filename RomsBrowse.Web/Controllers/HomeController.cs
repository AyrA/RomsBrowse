...
{
    public class HomeController(UserService userService, RomSearchService searchService, PlatformService platformService, SqlServerContext ctx) : BaseController(userService)
    {
